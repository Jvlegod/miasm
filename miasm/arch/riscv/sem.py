#
# Copyright (C) 2011 EADS France, Fabrice Desclaux <keke.oerv@isrc.iscas.ac.cn>
#
...
from miasm.arch.riscv.arch import mn_riscv, repeat_mn, replace_regs, is_mem_segm
...
LOG_RISCV_SEM = logging.getLogger("riscv_sem")
CONSOLE_HANDLER = logging.StreamHandler()
CONSOLE_HANDLER.setFormatter(logging.Formatter("[%(levelname)-8s]: %(message)s"))
LOG_RISCV_SEM.addHandler(CONSOLE_HANDLER)
LOG_RISCV_SEM.setLevel(logging.WARNING)
